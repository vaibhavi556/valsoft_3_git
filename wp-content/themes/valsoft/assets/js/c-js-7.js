      ...
      !(function (e, t) {
                ...
                value:
                  ...
                  function (e, t) {
                    ...
                    for (u.method = e, u.arg = t; ; ) {
                      ...
                      if ("normal" === o.type) {
                        if (
                          ((c = u.done ? "completed" : "suspendedYield"),
                          o.arg === h)
                        )
                          continue;
        ...
        function k(t, e, n, r, o) {
          var i = 3 < arguments.length && void 0 !== r ? r : "addEventListener",
            a =
              4 < arguments.length && void 0 !== o ? o : "removeEventListener",
                    ...
                    try {
                      ...
                      if (403 === e.domain_status_code)
                        return (
                          B(e, u),
                          void n(
                            new Error("“".concat(i, "” is not embeddable."))
                          )
                        );
                      t(e);
                    } catch (e) {
                ...
                o = new A(function (i, a) {
                  ...
                  (c._onMessage = function (e) {
                    if (g(e.origin) && c.element.contentWindow === e.source) {
                      ...
                      if (r || o)
                        return (
                          c.element.setAttribute("data-ready", "true"), void i()
                        );
                      z(c, t);
                    }
                  }),
      ...
      var scene = document.getElementById("v-scene");
      ...
      const arrVideos = [
        {
          poster:
            "https://i.vimeocdn.com/video/1572860845-6885021bdaafd055eba8313beaf026c3c99a5878463ed04521c1b27c92c5dbe8-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783424766/rendition/720p/file.mp4?loc=external&signature=0ffcc486309fcd8140eb0ee5d3f1deccc98b207604bc46cea1e615ee0a189588",
        },
        {
          poster:
            "https://i.vimeocdn.com/video/1572881225-5438f7005f8a011b62edf7e3967ae370b02f17d6a1edd39c84434d8b18783c3f-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783424744/rendition/720p/file.mp4?loc=external&signature=890787c2791c59f2a26ab685771e12e9a08b6a87c53da2eb17cc1876a38df02a",
        },
        {
          poster:
            "https://i.vimeocdn.com/video/1572860867-bc26aa18b605271873b7a1c0cef63ef4904da1b4eb937e22504bfa187ddc2256-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783424733/rendition/720p/file.mp4?loc=external&signature=81c2c648890c71b0cd3d0d9d9af2b3cf6933d130d5e1393ae96bc807d475dcae",
        },
        {
          poster:
            "https://i.vimeocdn.com/video/1572860871-0c5d879fc1e79acfe113bbc1c6291f1c19feb994d6713608867ddd628aeed980-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783424706/rendition/720p/file.mp4?loc=external&signature=7a12cbdcb9ba761f55893284a55c958c804ca78ebb7f3ebeb86a0fedc9317c37",
        },
        {
          poster:
            "https://i.vimeocdn.com/video/1572860983-d5bd92d5a451578255b3c4f31155134dd7b47020dda5cc61dcaad70dcc197409-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783424689/rendition/720p/file.mp4?loc=external&signature=2b02622ae82e903a6569e53b939fc5a05650b28f90f7d1d0f49d2eadd521ac3c",
        },
        {
          poster:
            "https://i.vimeocdn.com/video/1572860809-a8cebf68464fbe3954ef4ca3f4a1a78b489376989e34bd4cc7b328daf27dfc28-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783424673/rendition/720p/file.mp4?loc=external&signature=a351decdadf7e7a20c5293077d63e6b09588fe3400400385c25c627430b94ef3",
        },
        {
          poster:
            "https://i.vimeocdn.com/video/1572856458-c5f7ce586ef5d757c06a190b12d7a6ffee434478e9aeb384ce60a3fec068db74-d_240",
          video:
            "https://player.vimeo.com/progressive_redirect/playback/783422279/rendition/720p/file.mp4?loc=external&signature=8f3ad2cea048cbc1603d5d1a4ec2016663fb63ad4dbc1444e9128606be8748bb",
        },
      ];
      const rndInt = Math.floor(Math.random() * 6) + 1;
      const video = arrVideos[rndInt];

      jQuery(document).ready(function ($) {
        $("#home-video-wrapper").html(
          '<video autoplay preload loop muted playsinline poster="' +
            video.poster +
            '"><source src="' +
            video.video +
            '"></video>'
